        ...
        <div class="formulario">
          <form>
            ...
            <div class="row mb-5">
              ...
              <div class="col-sm-10">
                <input type="file" class="form-control" id="txt_foto1">
              </div>
            </div>
            <div class="row mb-5">
              <label for="foto" class="col-sm-2 col-form-label">Foto</label>
              <div class="col-sm-10">
                <input type="file" class="form-control" id="txt_foto2">
              </div>
            </div>
            <div class="row mb-5">
              <label for="foto" class="col-sm-2 col-form-label">Foto</label>
              <div class="col-sm-10">
                <input type="file" class="form-control" id="txt_foto3">
              </div>
            </div>
            <div class="row mb-5">
              <label for="foto" class="col-sm-2 col-form-label">Foto</label>
              <div class="col-sm-10">
                <input type="file" class="form-control" id="txt_foto4">
              </div>
            </div>
